...
for i in airport:
    for k in [[15, 17], [15, 22]]:
        ...
        time.sleep(5)
        # browser.find_element_by_xpath('//*[@id="search-autocomplete__input-PICKUP"]').send_keys(Keys.ARROW_DOWN)
        # browser.find_element_by_xpath('//*[@id="search-autocomplete__input-PICKUP"]').send_keys(Keys.RETURN)
